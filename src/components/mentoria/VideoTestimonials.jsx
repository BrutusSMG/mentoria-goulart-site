...
const VideoTestimonials = () => {
  ...
  return (
    ...
    <section id="depoimentos" className="relative bg-[#171f35] py-20 md:py-32 px-4 overflow-hidden">
      <div 
      ...
      <div className="relative z-10 text-center mt-8">
        <a 
          ...
          className="bg-[#d89900] text-white font-bold text-lg py-4 px-8 rounded-lg hover:bg-[#F7FA83] transition-colors inline-block"
        >
